...
for n = 1:9167-24
    allDate = datenum(PGPlazaalldata.Date(n),formatIn);
    isvalid = year(allDate) == 2018;
    if isnan(PGPlazaalldata.Time(n)) && isvalid
    alldatetime(i,1) = PGPlazaalldata.Date(n) + (" 00:00");
    alldatetime(i + 1,1) = PGPlazaalldata.Date(n+1) + (" 01:00");
    alldatetime(i + 2,1) = PGPlazaalldata.Date(n+2) + (" 02:00");
    alldatetime(i + 3,1) = PGPlazaalldata.Date(n+3) + (" 03:00");
    alldatetime(i + 4,1) = PGPlazaalldata.Date(n+4) + (" 04:00");
    alldatetime(i + 5,1) = PGPlazaalldata.Date(n+5) + (" 05:00");
    alldatetime(i + 6,1) = PGPlazaalldata.Date(n+6) + (" 06:00");
    alldatetime(i + 7,1) = PGPlazaalldata.Date(n+7) + (" 07:00");
    alldatetime(i + 8,1) = PGPlazaalldata.Date(n+8) + (" 08:00");
    alldatetime(i + 9,1) = PGPlazaalldata.Date(n+9) + (" 09:00");
    alldatetime(i + 10,1) = PGPlazaalldata.Date(n+10) + (" 10:00");
    alldatetime(i + 11,1) = PGPlazaalldata.Date(n+11) + (" 11:00");
    alldatetime(i + 12,1) = PGPlazaalldata.Date(n+12) + (" 12:00");
    alldatetime(i+ 13,1) = PGPlazaalldata.Date(n+13) + (" 13:00");
    alldatetime(i + 14,1) = PGPlazaalldata.Date(n+14) + (" 14:00");
    alldatetime(i + 15,1) = PGPlazaalldata.Date(n+15) + (" 15:00");
    alldatetime(i + 16,1) = PGPlazaalldata.Date(n+16) + (" 16:00");
    alldatetime(i + 17,1) = PGPlazaalldata.Date(n+17) + (" 17:00");
    alldatetime(i + 18,1) = PGPlazaalldata.Date(n+18) + (" 18:00");
    alldatetime(i + 19,1) = PGPlazaalldata.Date(n+19) + (" 19:00");
    alldatetime(i + 20,1) = PGPlazaalldata.Date(n+20) + (" 20:00");
    alldatetime(i + 21,1) = PGPlazaalldata.Date(n+21) + (" 21:00");
    alldatetime(i + 22,1) = PGPlazaalldata.Date(n+22) + (" 22:00");
    alldatetime(i + 23,1) = PGPlazaalldata.Date(n+23) + (" 23:00");
    i = i + 24;
    end
end
%% Boxplots
